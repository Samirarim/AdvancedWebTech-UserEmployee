...
export class WaiterService {
    ...
    async getWaiterByID(w_id) {
        const data=await this.WaiterRepo.findOneBy({ w_id });
        console.log(data);
        if(data!==null) {
            return data;
        }
